 ...
 *
 * <p>모듈 간 의존: risk 모듈(PositionBook/KillSwitch/DailyLimitTracker/DailyPnlTracker,
 * 기존과 동일) 외에, {@link com.autostock.monitor.TradingSystemManager}가 시작 절차에서
 * execution 모듈의 {@code ReconciliationService.reconcile()}을 직접 호출한다(LIVE 모드
 * 준비 절차, ARCHITECTURE.md 8·10절) — execution은 monitor를 참조하지 않으므로 순환은 없다.
