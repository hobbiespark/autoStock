...
class ReconciliationServiceTest {
    ...
    void setUp() {
        ...
        ExecutionProperties liveProperties = new ExecutionProperties(ExecutionProperties.Mode.LIVE, Duration.ofMinutes(5));
    ...
    void SIM_모드에서는_startup_이벤트로_대사하지_않는다() {
        ExecutionProperties simProperties = new ExecutionProperties(ExecutionProperties.Mode.SIM, Duration.ofMinutes(5));
